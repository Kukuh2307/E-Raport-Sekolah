...
<div class="row">
    ...
    <form action="/Kelas" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <select class="form-select @error('guru_id') is-invalid @enderror" id="guru_id" name="guru_id" value="{{ old('guru_id') }}" id="guru_id" name="guru_id">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('tahun_ajaran') is-invalid @enderror" id="tahun_ajaran" name="tahun_ajaran" value="{{ old('tahun_ajaran') }}">
            @error('tahun_ajaran')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
